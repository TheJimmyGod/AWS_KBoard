-- 기존테이블 내용 삭제 (★★★★★ 무조건 자식(t5_attachment)부터 삭제)
...
-- 샘플 authority (★★★★★ "ROLE" <- Security 의 접두어)
INSERT INTO t5_authority (name) VALUES ('ROLE_MEMBER'), ('ROLE_ADMIN');

-- 샘플 t5_user
INSERT INTO t5_user (username, password, name, email) VALUES
('USER1','$2a$10$W0GlkIcmfwR0Yy8nDpy0P.Nh/PaEO0x4krP6OLlMUxd2AmmZ20yIG', '회원1', 'user1@mail.com'),
('USER2','$2a$10$3OErphvV3uvrc8VaEoux.eRccGlI53N6VUP2emWNccIxmKKLNmYda', '회원2', 'user2@mail.com'),
('ADMIN1','$2a$10$1z.5C3HoZxAUFMZvZamlFe.iqziPaJWf4NFytqYI/k9QEjRjCEaSW', '관리자1', 'admin1@mail.com')
;
