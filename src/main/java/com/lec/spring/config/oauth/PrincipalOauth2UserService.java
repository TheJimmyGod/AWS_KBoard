...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
       ...
       """.formatted(userRequest.getClientRegistration(), // clientRegistration
                ...
                oAuth2User.getAuthorities()) // Map<String,Object> 사용자 프로필 정보
        );
...
//redirect: http://localhost:8080/login/oauth2/code/naver
//Client ID: TAkbCCstmahX0oZ76Vgn
//Client Secret: mtlGCe89D2
//로그인 연동 URL: https://nid.naver.com/oauth2.0/authorize
//AccessToken: https://nid.naver.com/oauth2.0/token
//사용자 프로필: https://openapi.naver.com/v1/nid/me